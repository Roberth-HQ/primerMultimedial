        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" href="#">Bienvenido administrador:<?php $_SESSION['username'] ?> </a>
                    </li>
                </ul>
                <div class="d-flex">
                    <button class="btn btn-warning" onclick="window.location.href='process_anadir_persona.php';">Crear Persona</button>
    ...
    <table class="table table-striped custom-table custom-table">
        ...
        <?php
            while($fila = mysqli_fetch_array($resultado)) {
                ...
                echo "<td>";
                echo "<a href='editar_persona.php?ci=$fila[ci]' class='btn btn-success btn-sm'>Editar</a> ";
                echo "<a href='process_eliminar_persona.php?ci=$fila[ci]' class='btn btn-danger btn-sm'>Eliminar</a>";
                echo "<a href='catastro.php?ci=$fila[ci]' class='btn btn-info'>Propiedades</a>";
                echo "</td>";
                echo "</tr>";
            }
        ?>
