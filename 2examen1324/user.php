        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav2">
                <ul class="navbar-nav w-100 justify-content-between">
                    ...
                    <li class="nav-item">
                        <a class="nav-link btn btn-light" href="#">Evalúenos</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link btn btn-light" href="#">Instructivos CEL</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <table class="table table-striped custom-table">
            ...
            <tbody>
                ...
                while ($fila = mysqli_fetch_array($resultado_catastro)) {
                    ...
                    echo "<button class='btn btn-outline-warning' onclick=\"window.location.href='http://localhost:8090/mavenproject2/php2?cod=$fila[cod]';\">Control de Pago en JAVA</button>";
                    echo "</td>";
                    echo "</tr>";
                }
                ?>
