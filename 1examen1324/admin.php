    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-main py-2">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <div class="d-flex">
                    <button class="btn btn-outline-light" onclick="window.location.href='login.php';">Cerrar sesión</button>
                </div>
            </div>
        </div>
    </nav>
    ...
    <table class="table table-striped custom-table custom-table">
        ...
        <?php
            while($fila = mysqli_fetch_array($resultado)) {
                ...
                echo "<a href='eliminar_persona.php?ci=$fila[ci]' class='btn btn-danger btn-sm'>Eliminar</a>";
                echo "</td>";
                echo "</tr>";
            }
        ?>
